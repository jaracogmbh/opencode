export const dict = {
  ...
  "command.identity.open": "Identity",
  "command.identity.open.description": "Manage Keycloak identity",
  ...
  "dialog.identity.title": "Identity",
  "dialog.identity.description": "Manage Keycloak sign-in for this browser session.",
  "dialog.identity.status.loggedOut": "Not logged in",
  "dialog.identity.status.active": "Keycloak SSO active",
  "dialog.identity.status.expired": "Keycloak SSO expired",
  "dialog.identity.field.issuer": "Keycloak issuer URL",
  "dialog.identity.field.clientId": "Keycloak client ID",
  "dialog.identity.field.scope": "Scopes",
  "dialog.identity.field.clientSecret": "Client secret",
  "dialog.identity.field.clientSecret.placeholder": "optional",
  "dialog.identity.action.login": "Log in",
  "dialog.identity.action.loginAgain": "Log in again",
  "dialog.identity.action.logout": "Log out",
  "dialog.identity.action.refresh": "Refresh",
  "dialog.identity.action.open": "Open verification page",
  "dialog.identity.waiting": "Waiting for Keycloak authorization",
  "dialog.identity.code": "Code",
  "dialog.identity.flow.device": "Using device flow",
  "dialog.identity.toast.loggedOut": "Logged out",
